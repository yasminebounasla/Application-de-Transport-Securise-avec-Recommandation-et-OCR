...
// Use shared UserAvatar component which handles absolute/relative URLs
    ...
    <ScrollView contentContainerStyle={d.container}>
      ...
      <View style={d.hero}>
        <View style={d.heroLeft}>
          <UserAvatar prenom={contact?.prenom} nom={contact?.nom} sexe={contact?.sexe} photoUrl={contact?.photoUrl} size={52} style={d.avatar} />
          <View style={{ flex: 1 }}>
