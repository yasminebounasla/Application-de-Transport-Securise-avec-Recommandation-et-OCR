...
export default function DriverHomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {/* Cartes Trajets */}
      <TouchableOpacity style={styles.pendingCard} onPress={() => router.push('/driver/RideRequestsScreen')}>
        <View>
      ...
      <View style={styles.section}>
        ...
        {loading ? (
          ...
          <TouchableOpacity style={styles.card} onPress={() => router.push('/driver/ActiveRideScreen')}>
            <Text style={styles.cardTitle}>
              {activeRide.startAddress || 'Départ'} -> {activeRide.endAddress || 'Destination'}
            </Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statsRow}>
          ...
          <StatBox icon="check-circle" label="Acceptés" value={stats.accepted} />
          <StatBox icon="flag" label="Terminés" value={stats.completed} />
        </View>
...
const styles = StyleSheet.create({
  ...
  pendingLabel: { fontSize: 17, fontWeight: '700', color: '#111' },
  pendingHint: { fontSize: 13, color: '#666', marginTop: 4 },
  badge: {
    minWidth: 36,
    height: 36,
    borderRadius: 18,
