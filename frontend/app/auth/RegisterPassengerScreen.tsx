...
export default function RegisterPassengerScreen() {
    ...
    return (
        <>
            <Stack.Screen options={{ title: 'Register as Passenger'}} />
            <ScrollView className="flex-1 bg-gray-50">
                <View className="px-6 py-8">
                    {/* Header */}
                    <View className="mb-8">
                        <Text className="text-3xl font-bold text-gray-800 mb-2">Join as Passenger</Text>
                        <Text className="text-gray-600">Create your account to start riding</Text>
                    </View>
