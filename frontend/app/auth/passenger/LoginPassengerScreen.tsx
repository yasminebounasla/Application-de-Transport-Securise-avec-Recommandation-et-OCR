...
import { validatePassengerLogin } from '../../../services/authService';
...
export default function LoginPassengerScreen() {
    ...
    const handleLogin = async () => {
        ...
        const result = await loginAsPassenger(normalizedEmail, password);

        if (result.success) {
            await showSuccessTransition('/(passengerTabs)/PassengerHomeScreen');
        } else {
