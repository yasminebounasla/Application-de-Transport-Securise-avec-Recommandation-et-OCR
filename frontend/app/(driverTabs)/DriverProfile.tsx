    ...
    try {
      ...
      try {
        const selfieRes = await api.get(
          `/verification/driver/${data.id}/selfie`,
        );
      ...
      <ScrollView
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text style={{ fontSize: 14, fontWeight: "700", color: "#CA8A04" }}>
              {(profile.stats?.averageRating || profile.avgRating || 0).toFixed(
                1,
              )}
            </Text>
            <Text style={{ fontSize: 12, color: "#CA8A04" }}>
              · See reviews
            </Text>
          </TouchableOpacity>
        ...
        <View
          ...
          <InfoRow
            ...
            label='Work Zone'
            value={profile.workZoneAddress || profile.wilaya || "—"}
            last
          />
